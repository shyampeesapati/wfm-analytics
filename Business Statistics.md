...
|----------|----------|----------|
| Specification and Methodology   | Data Collection Method, Response Rate, Quality & analysis of data, sampling technique & Size, Questionnaire design, fieldwork| Data Should be reliable, valid and generalizable to the problem   |
| Error & Accuracy | Examine errors in approach, research design, sampling, data collection and analysis, & reporting   | Assess accuracy by comparing data from different sources   |
| Currency   | Timelag between collection, publication and frequency of updates   | Census data are updated by syndicated firms   |
